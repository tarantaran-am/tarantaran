  ...
  return (
    <section className="relative overflow-hidden bg-foreground py-32 md:py-48">
      ...
      <Container className="relative text-center">
        <Eyebrow className="mb-8 text-background/45">{t("eyebrow")}</Eyebrow>
        <h2 className="mx-auto mb-7 max-w-3xl font-serif text-[length:var(--text-hero-cta)] leading-[1.05] text-background">
          {t("title")}
        </h2>
        <p className="mx-auto mb-12 max-w-md text-[15px] leading-relaxed text-background/55">{t("subtitle")}</p>
